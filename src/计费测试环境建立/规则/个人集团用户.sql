...
VALUES( @city_code, @rule_id, 1, @group_id, @cond_id, 0, 'IFPERSONAL', '', @oper_code, @result , concat(@note,@result));
SET @rule_id := @rule_id +1;
SET @note = "集团A用户";
INSERT INTO icp.bf_rule_config_t
(city_code, rule_id, sys_id, group_id, cond_id, cond_type, obj_code, params, oper_code, `result`, note)
VALUES( @city_code, @rule_id, 1, @group_id, @cond_id, 0, 'GROUPKIND', '', @oper_code, @result , concat(@note,@result));
SET @rule_id := @rule_id +1;
SET @note = "集团B用户";
INSERT INTO icp.bf_rule_config_t
(city_code, rule_id, sys_id, group_id, cond_id, cond_type, obj_code, params, oper_code, `result`, note)
